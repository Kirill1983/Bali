...
public class TestNGProjectBuilder implements ProjectBuilder {
...
protected ExtFileFilter testFileFilter = new ExtFileFilter("testmain.class");

protected ProjectService projectSvc;
protected TestNGProject project;

public TestNGProjectBuilder(){
	
}

public TestNGProjectBuilder(ProjectService projectSvc_){
...
public BaseProject createProjectFromDir(String name, String binpath, String libpath, HashMap<String, String[]> factory, String parentProjectName) throws Exception {
	...
	TestNGProject proj = new TestNGProject(name);
...
public void init(BaseProject proj) throws Exception  {
	...
	this.project = (TestNGProject) proj;
...
private URLClassLoader createClassLoader(String binfolderpath, String libpaths, URLClassLoader parentLoader) throws Exception {
