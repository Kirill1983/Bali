...
package com.spiffy.tests.web;


import java.util.Properties;

import com.spiffy.framework.app.SpiffyApp;
...
public class BaseTestWeb extends BaseTestBali {

	protected static final Logger log = LogManager.getLogger(BaseTestWeb.class);
	protected SpiffyApp spiffyApp;
