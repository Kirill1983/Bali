...
import org.kkonoplev.bali.restdemo.EmployeeListVO;
import org.kkonoplev.bali.restdemo.EmployeeVO;
...
public class PadController {
	    ...
	    public String run(HttpServletRequest req, HttpServletResponse res, @ModelAttribute("SuiteMdl") SuiteMdl suiteMdl) throws Exception {
			...
			if (suiteMdl.getName().equals(""))
				suiteMdl.setName("manual");		
			
			log.info("************SuiteMdl run*************");
			log.info("result dir:"+suiteMdl.getResultDir());
