...
public class MainProjectBuilder implements ProjectBuilder {
...
public MainProjectBuilder(){
	
}

public MainProjectBuilder(ProjectService projectSvc_){
...
private void initResourceStorages() throws Exception {
	log.info("Init ResourceStorages");
