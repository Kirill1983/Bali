...
public class NavbarBaliTag extends SimpleTagSupport {
    ...
    private static final String    NAV_NODES_STATUS     = "gridnodesstatus";
            ...
            if (!_hideTabs) {
	            ...
	            for (MenuAc menu : menus) {
	                ...
	                if (menu.getId().equals(mainMenu) && children != null && !children.isEmpty()) {
                        ...
                        secBar.append("          <a href=\"/baligridhub/doc/html/index.htm\" title=\"");
    ...
    private static MenuAc[] getMenus(String currentMenu) {
    	String prefix = "openUrl('/baligridhub";
        ...
        status.addChild(new MenuAc(NAV_NODES_STATUS, "navbar.gridnodesstatus",
    			"navbar.gridnodesstatus.alt", prefix+"/form/status/gridnodes')"));
