...
<form name=viewForm action="/baligridhub/form/status/suitecontext" target='_blank' method="get">
...
<tr><td colspan=3 class="svcHdr" style="width:200px;"> Active and last 7 suites context's history: </td></tr>
	...
	<c:forEach items="${lasttenlist}" var="entry">
    	<tr>
    		...
    		<td class="svcBody" style="width:160px;">  <a href="/baligridhub/form/status/suitecontext?resultDir=${entry.key}"> ${entry.key} </a> </td>
