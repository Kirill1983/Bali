...
public class StatusController {
	...
	public static final String projectsjsonTile = "projectsjson";
	...
	private static final String redirectActivityStatus = "redirect:/form/status/activity";
	    ...
	    public String resultsstatus(HttpServletRequest req) throws Exception {
			...
			req.setAttribute("lasttenlist", BaliServices.getSuiteService().getLastTenSuiteContexts());
	    ...
	    public String resourcesstatusjson(HttpServletRequest req, HttpServletResponse res) throws Exception {		
	    ...
	    public String projectsjson(HttpServletRequest req, HttpServletResponse res) throws Exception {		
			...
			SuiteService suiteSvc = BaliServices.getSuiteService();
			Gson gson = new Gson();
			String json = gson.toJson(suiteSvc.getSuiteExecProcessor().getProjectSvc().getProjectTestsList());
			req.setAttribute("json", json);
		 	return projectsjsonTile;		
		}
	    ...
	    public String suiteContext(HttpServletRequest req, HttpServletResponse res, @ModelAttribute("SuiteExecContext") SuiteExecContext suiteExecContext) throws Exception {
	    ...
	    public String perfomanceReport(HttpServletRequest req, HttpServletResponse res, @ModelAttribute("SuiteExecContext") SuiteExecContext suiteExecContext) throws Exception {
		...
		@RequestMapping(value="/suitecontext/perf/json")
	    public String suiteContextPerfJson(HttpServletRequest req, HttpServletResponse res, @ModelAttribute("SuiteExecContext") SuiteExecContext suiteExecContext) throws Exception {		
			...
			Gson gson = new Gson();
			String json = gson.toJson(ctx.getPerfomanceReport());
			req.setAttribute("json", json);
		 	return projectsjsonTile;		
		}

		@RequestMapping(value="/suitecontext/classifyreport/json")
	    public String suiteContextClassifyRptJson(HttpServletRequest req, HttpServletResponse res, @ModelAttribute("SuiteExecContext") SuiteExecContext suiteExecContext) throws Exception {		
		    
			res.addHeader("Access-Control-Allow-Origin", "*");
			SuiteService suiteSvc = BaliServices.getSuiteService();	
			SuiteExecContext ctx = suiteSvc.getSuiteExecContext(suiteExecContext.getResultDir());
			
			Gson gson = new GsonBuilder().setPrettyPrinting().registerTypeAdapterFactory(MergeClassifyReports.runtimeTypeAdapterFactory).create();
			String json = gson.toJson(ctx.getClassifyReport());
			req.setAttribute("json", json);
		 	return projectsjsonTile;		
		}
	    ...
	    public String rerun(HttpServletRequest req, HttpServletResponse res) throws Exception {
			...
			suiteSvc.getSuiteExecProcessor().rerunWarnings(suiteExecContext, warningsIds);	
			suiteSvc.getSuiteExecProcessor().notifyExecutors();
	    ...
	    public String deletecontext(HttpServletRequest req, HttpServletResponse res, @ModelAttribute("SuiteExecContext") SuiteExecContext suiteExecContext) throws Exception {
			...
			req.setAttribute("suiteExecContext", suiteSvc.getLastTenSuiteContexts().get(0));			
		 	return suiteContextRefreshTile;
