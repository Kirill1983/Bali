...
<td class="svcAll" style="width: 200px;"> 
	<a  href="/bali/form/status/suitecontext?resultDir=${suiteExecContext.resultDir}"> Suite Execution Context View </a>
</td>
</tr>
</table>
...
<c:forEach var="operation" items="${suiteExecContext.perfomanceReport.operations}">
<tr>
