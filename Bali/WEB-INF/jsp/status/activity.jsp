...
<tr><td class="svcHdr" style="width:250px;"> Active Suite Contexts Execution List: </td></tr>
	...
	<c:forEach items="${execContexts}" var="context">
    	<tr>
    		<td class="svcBody">  <a href="/bali/form/status/suitecontext?resultDir=${context.resultDir}"> ${context.resultDir}  ${context.suiteMdl.options} </a>  </td>
    	</tr>
	</c:forEach>		
